...
func (entity *Tancy_0x0011) MsgID() MsgID {
	return Msgtancy_0x0011
}

func (entity *Tancy_0x0011) Encode() ([]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (entity *Tancy_0x0011) Decode(data []byte) (int, error) {
	datalen := len(data)
	if datalen < 44 {
