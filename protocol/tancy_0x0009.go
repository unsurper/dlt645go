...
func (entity *Tancy_0x0009) MsgID() MsgID {
	return Msgtancy_0x0009
}

func (entity *Tancy_0x0009) Encode() ([]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (entity *Tancy_0x0009) Decode(data []byte) (int, error) {
	datalen := len(data)
	if datalen < 50 {
